...
createAppKit({
  ...
  metadata: {
    name: 'Base Jump',
    description: 'Base Jump Mini App - Jump, collect candy, and earn rewards!',
    url: 'https://base-jump-five.vercel.app',
    icons: ['https://base-jump-five.vercel.app/images/icon.jpg']
  },
  features: {
